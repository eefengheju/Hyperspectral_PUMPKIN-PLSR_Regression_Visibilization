...
###################导出图片
        pumpkin_data=corrected_nparr[stats[pnum][1]:stats[pnum][1]+stats[pnum][3],stats[pnum][0]:stats[pnum][0]+stats[pnum][2],]
        np.save('data/'+name+'.npy',pumpkin_data)
